...
/**
 * /admin/expenses — the create-expense page.
 *
 * Mirrors the `/admin/income` route: the sidebar links to `/admin/expenses`
 * directly, and `/admin/expenses/new` is the same page reachable via the
 * alternative URL. Both render the same form.
 */
